...
x2 <- getURL("https://raw.githubusercontent.com/lanec-unifesspa/5-HT-CAS/master/data/PCPA/PCPA_after.csv")
CLZ_after_exposure <- read.csv(text = x2)
# Ensure factor variables are interpreted as such
CLZ_after_exposure$Treatment <- factor(CLZ_after_exposure$Treatment, levels = c("CTRL", "CAS"))
CLZ_after_exposure$Dose <- factor(CLZ_after_exposure$Dose, levels = c("VEH", "pCPA"))
