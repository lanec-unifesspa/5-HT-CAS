...
TBplotDur <- ggplot(RS_during, aes(x = factor(Dose), y = TimeBottom, colour = Treatment)) + geom_boxplot(outlier.shape = NA) + geom_point(data = TBInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + ylim(0, 380) + geom_line(data = TBInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_jitter(position = "dodge", alpha = 0.3) + geom_hline(yintercept = 120, linetype = "dashed", color = "gray") + labs(x = "Drug", y = "Time on bottom (s)", color = "Treatment") + scale_colour_brewer(palette = "Set1") + theme_bw() + annotate(geom = "text", x = 0.8, y = 290, label = "b")  +  annotate(geom = "text", x = 1.2, y = 370, label = "a")  + annotate(geom = "text", x = 1.8, y = 270, label = "b")  + annotate(geom = "text", x = 2.2, y = 370, label = "a") 
```
...
TTplotAfter <- ggplot(RS_after, aes(x = factor(Dose), y = TimeTop, colour = Treatment)) + geom_boxplot(outlier.shape = NA) + geom_point(data = TTInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + ylim(0, 360) + geom_line(data = TTInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_jitter(position = "dodge", alpha = 0.3) + geom_hline(yintercept = 120, linetype = "dashed", color = "gray") + labs(x = "Dose", y = "Time on top (s)", color = "Treatment") + scale_colour_brewer(palette = "Accent") + theme_bw() + annotate(geom = "text", x = 0.8, y = 140, label = "a")  +  annotate(geom = "text", x = 1.2, y = 155, label = "a")  + annotate(geom = "text", x = 1.8, y = 130, label = "a")  + annotate(geom = "text", x = 2.2, y = 135, label = "a") 
```
...
TBplotAfter <- ggplot(RS_after, aes(x = factor(Dose), y = TimeBottom, colour = Treatment)) + geom_boxplot(outlier.shape = NA) + geom_point(data = TBInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + ylim(0, 380) + geom_line(data = TBInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_jitter(position = "dodge", alpha = 0.3) + geom_hline(yintercept = 120, linetype = "dashed", color = "gray") + labs(x = "Drug", y = "Time on bottom (s)", color = "Treatment") + scale_colour_brewer(palette = "Accent") + theme_bw() + annotate(geom = "text", x = 0.8, y = 280, label = "ab")  +  annotate(geom = "text", x = 1.2, y = 370, label = "a")  + annotate(geom = "text", x = 1.8, y = 250, label = "b")  + annotate(geom = "text", x = 2.2, y = 260, label = "b") 
```
...
FrplotAfter <- ggplot(RS_after, aes(x = factor(Dose), y = Freezing, colour = Treatment)) + ylim (0, 360) + geom_boxplot(outlier.shape = NA) + geom_point(data = FrInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_line(data = FrInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_jitter(position = "dodge", alpha = 0.3) + labs(x = "Dose", y = "Freezing (s)", color = "Treatment") + scale_colour_brewer(palette = "Accent") + theme_bw() + annotate(geom = "text", x = 0.8, y = 50, label = "b")  +  annotate(geom = "text", x = 1.2, y = 240, label = "a")  + annotate(geom = "text", x = 1.8, y = 100, label = "b")  + annotate(geom = "text", x = 2.2, y = 170, label = "c") 
```
...
SpplotAfter <- ggplot(RS_after, aes(x = factor(Dose), y = Speed, colour = Treatment)) + ylim(0, 16) + geom_boxplot(outlier.shape = NA) + geom_point(data = SpInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_line(data = SpInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_jitter(position = "dodge", alpha = 0.3) + labs(x = "Dose", y = "Speed (cm/s)", color = "Treatment") + scale_colour_brewer(palette = "Accent") + theme_bw() + annotate(geom = "text", x = 0.8, y = 12, label = "a")  +  annotate(geom = "text", x = 1.2, y = 15, label = "a")  + annotate(geom = "text", x = 1.8, y = 15, label = "a")  + annotate(geom = "text", x = 2.2, y = 12, label = "a")
```
