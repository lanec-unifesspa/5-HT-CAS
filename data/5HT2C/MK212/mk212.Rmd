...
TTplotDur <- ggplot(mk212_during.nooutlier, aes(x = factor(Dose), y = Time.Top, colour = Treatment)) + geom_boxplot(outlier.shape = NA) + geom_point(data = TTInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + ylim(0, 360) + geom_line(data = TTInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_jitter(position = "dodge", alpha = 0.3) + geom_hline(yintercept = 120, linetype = "dashed", color = "gray") + labs(x = "Dose", y = "Time on top (s)", color = "Treatment") + scale_colour_brewer(palette = "Set1") + theme_bw() + annotate(geom = "text", x = 0.8, y = 80, label = "a") + annotate(geom = "text", x = 1.2, y = 70, label = "a") +  annotate(geom = "text", x = 1.8, y = 240, label = "b") + annotate(geom = "text", x = 2.2, y = 75, label = "a") + annotate(geom = "text", x = 2.8, y = 120, label = "ab") + annotate(geom = "text", x = 3.2, y = 120, label = "ab")
```
...
TBplotDur <- ggplot(mk212_during.nooutlier, aes(x = factor(Dose), y = Time.Bottom, colour = Treatment)) + geom_boxplot(outlier.shape = NA) + geom_point(data = TBInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + ylim(0, 370) + geom_line(data = TBInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_jitter(position = "dodge", alpha = 0.3) + geom_hline(yintercept = 120, linetype = "dashed", color = "gray") + labs(x = "Dose", y = "Time on bottom (s)", color = "Treatment") + scale_colour_brewer(palette = "Set1") + theme_bw() + annotate(geom = "text", x = 0.8, y = 280, label = "bc") + annotate(geom = "text", x = 1.2, y = 365, label = "a") +  annotate(geom = "text", x = 1.8, y = 365, label = "b") + annotate(geom = "text", x = 2.2, y = 365, label = "ac") + annotate(geom = "text", x = 2.8, y = 365, label = "b") + annotate(geom = "text", x = 3.2, y = 365, label = "b")
```
...
ESplotDur <- ggplot(mk212_after.nooutlier, aes(x = factor(Dose), y = AbsoluteTurnAngle, colour = Treatment)) +  ylim(0, 90) + geom_boxplot(outlier.shape = NA) + geom_point(data = ESInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_line(data = ESInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_jitter(position = "dodge", alpha = 0.3) + labs(x = "Dose", y = "Erratic swimming \n(Abs. Turn Angle)", color = "Treatment") + scale_colour_brewer(palette = "Set1") + theme_bw() + annotate(geom = "text", x = 0.8, y = 35, label = "b") + annotate(geom = "text", x = 1.2, y = 65, label = "a") +  annotate(geom = "text", x = 1.8, y = 55, label = "a") + annotate(geom = "text", x = 2.2, y = 33, label = "b") + annotate(geom = "text", x = 2.8, y = 48, label = "a") + annotate(geom = "text", x = 3.2, y = 35, label = "b")
```
...
FrplotDur <- ggplot(mk212_during.nooutlier, aes(x = factor(Dose), y = Freezing.S, colour = Treatment)) + geom_boxplot(outlier.shape = NA) + geom_point(data = FrNInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_line(data = FrNInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_jitter(position = "dodge", alpha = 0.3) + labs(x = "Dose", y = "Freezing (s)", color = "Treatment") + scale_colour_brewer(palette = "Set1") + theme_bw() + annotate(geom = "text", x = 0.8, y = 30, label = "bc") + annotate(geom = "text", x = 1.2, y = 175, label = "a") +  annotate(geom = "text", x = 1.8, y = 30, label = "b") + annotate(geom = "text", x = 2.2, y = 220, label = "ac") + annotate(geom = "text", x = 2.8, y = 30, label = "abc") + annotate(geom = "text", x = 3.2, y = 45, label = "abc")
```
...
SpplotDur <- ggplot(mk212_during.nooutlier, aes(x = factor(Dose), y = Speed, colour = Treatment)) + geom_boxplot(outlier.shape = NA) + geom_point(data = SpInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_line(data = SpInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_jitter(position = "dodge", alpha = 0.3) + labs(x = "Dose", y = "Speed (cm/s)", color = "Treatment") + scale_colour_brewer(palette = "Set1") + theme_bw() + annotate(geom = "text", x = 0.8, y = 13, label = "a") + annotate(geom = "text", x = 1.2, y = 14, label = "a") +  annotate(geom = "text", x = 1.8, y = 15, label = "a") + annotate(geom = "text", x = 2.2, y = 18, label = "a") + annotate(geom = "text", x = 2.8, y = 14.5, label = "a") + annotate(geom = "text", x = 3.2, y = 15, label = "a")
```
...
TTplotAfter <- ggplot(mk212_after.nooutlier, aes(x = factor(Dose), y = Time.Top, colour = Treatment)) + geom_boxplot(outlier.shape = NA) + geom_point(data = TTInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + ylim(0, 360) + geom_line(data = TTInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_jitter(position = "dodge", alpha = 0.3) + geom_hline(yintercept = 120, linetype = "dashed", color = "gray") + labs(x = "Dose", y = "Time on top (s)", color = "Treatment") + scale_colour_brewer(palette = "Accent") + theme_bw() + annotate(geom = "text", x = 0.8, y = 70, label = "a") + annotate(geom = "text", x = 1.2, y = 65, label = "a") +  annotate(geom = "text", x = 1.8, y = 120, label = "b") + annotate(geom = "text", x = 2.2, y = 75, label = "ab") + annotate(geom = "text", x = 2.8, y = 60, label = "ab") + annotate(geom = "text", x = 3.2, y = 60, label = "ab")
```
...
TBplotAfter <- ggplot(mk212_after.nooutlier, aes(x = factor(Dose), y = Time.Bottom, colour = Treatment)) + geom_boxplot(outlier.shape = NA) + geom_point(data = TBInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + ylim(0, 370) + geom_line(data = TBInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_jitter(position = "dodge", alpha = 0.3) + geom_hline(yintercept = 120, linetype = "dashed", color = "gray") + labs(x = "Dose", y = "Time on bottom (s)", color = "Treatment") + scale_colour_brewer(palette = "Accent") + theme_bw() + annotate(geom = "text", x = 0.8, y = 360, label = "a") + annotate(geom = "text", x = 1.2, y = 370, label = "a") +  annotate(geom = "text", x = 1.8, y = 360, label = "b") + annotate(geom = "text", x = 2.2, y = 370, label = "a") + annotate(geom = "text", x = 2.8, y = 370, label = "a") + annotate(geom = "text", x = 3.2, y = 370, label = "a")
```
...
ESplotAfter <- ggplot(mk212_after.nooutlier, aes(x = factor(Dose), y = AbsoluteTurnAngle, colour = Treatment)) +  ylim(0, 90) + geom_boxplot(outlier.shape = NA) + geom_point(data = ESInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_line(data = ESInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_jitter(position = "dodge", alpha = 0.3) + labs(x = "Dose", y = "Erratic swimming \n(Abs. Turn Angle)", color = "Treatment") + scale_colour_brewer(palette = "Accent") + theme_bw() + annotate(geom = "text", x = 0.8, y = 30, label = "b") + annotate(geom = "text", x = 1.2, y = 33, label = "ab") +  annotate(geom = "text", x = 1.8, y = 45, label = "ac") + annotate(geom = "text", x = 2.2, y = 33, label = "ab") + annotate(geom = "text", x = 2.8, y = 43, label = "ab") + annotate(geom = "text", x = 3.2, y = 48, label = "c")
```
...
FrplotAfter <- ggplot(mk212_after.nooutlier, aes(x = factor(Dose), y = Freezing.S, colour = Treatment)) +  ylim(0, 90) + geom_boxplot(outlier.shape = NA) + geom_point(data = FrSInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_line(data = FrSInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_jitter(position = "dodge", alpha = 0.3) + labs(x = "Dose", y = "Freezing (s)", color = "Treatment") + scale_colour_brewer(palette = "Accent") + theme_bw() + annotate(geom = "text", x = 0.8, y = 10, label = "b") + annotate(geom = "text", x = 1.2, y = 79, label = "a") +  annotate(geom = "text", x = 1.8, y = 6, label = "b") + annotate(geom = "text", x = 2.2, y = 6, label = "b") + annotate(geom = "text", x = 2.8, y = 6, label = "b") + annotate(geom = "text", x = 3.2, y = 12, label = "b")
```
...
SpplotAfter <- ggplot(mk212_after.nooutlier, aes(x = factor(Dose), y = Speed, colour = Treatment)) + geom_boxplot(outlier.shape = NA) + geom_point(data = SpInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_line(data = SpInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_jitter(position = "dodge", alpha = 0.3) + labs(x = "Dose", y = "Speed (cm/s)", color = "Treatment") + scale_colour_brewer(palette = "Accent") + theme_bw() + annotate(geom = "text", x = 0.8, y = 15, label = "a") + annotate(geom = "text", x = 1.2, y = 15, label = "a") +  annotate(geom = "text", x = 1.8, y = 15, label = "a") + annotate(geom = "text", x = 2.2, y = 15, label = "a") + annotate(geom = "text", x = 2.8, y = 15, label = "a") + annotate(geom = "text", x = 3.2, y = 15, label = "a")
```
...
TTplotARS <- ggplot(mk212_ARS, aes(x = factor(Drug), y = Time.Top, colour = Treatment)) + geom_boxplot(outlier.shape = NA) + geom_point(data = TTInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + ylim(0, 360) + geom_line(data = TTInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_jitter(position = "dodge", alpha = 0.3) + geom_hline(yintercept = 120, linetype = "dashed", color = "gray") + labs(x = "Dose", y = "Time on top (s)", color = "Treatment") + scale_colour_brewer(palette = "Set2") + theme_bw() + annotate(geom = "text", x = 0.8, y = 230, label = "b")  +  annotate(geom = "text", x = 1.2, y = 60, label = "a")  + annotate(geom = "text", x = 1.8, y = 170, label = "ab")  + annotate(geom = "text", x = 2.2, y = 110, label = "ab") 
```
...
TBplotARS <- ggplot(mk212_ARS, aes(x = factor(Drug), y = Time.Bottom, colour = Treatment)) + geom_boxplot(outlier.shape = NA) + geom_point(data = TBInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + ylim(0, 380) + geom_line(data = TBInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_jitter(position = "dodge", alpha = 0.3) + geom_hline(yintercept = 120, linetype = "dashed", color = "gray") + labs(x = "Dose", y = "Time on bottom (s)", color = "Treatment") + scale_colour_brewer(palette = "Set2") + theme_bw() + annotate(geom = "text", x = 0.8, y = 300, label = "b")  +  annotate(geom = "text", x = 1.2, y = 380, label = "a")  + annotate(geom = "text", x = 1.8, y = 320, label = "ab")  + annotate(geom = "text", x = 2.2, y = 300, label = "ab") 
```
...
ESplotARS <- ggplot(mk212_ARS, aes(x = factor(Drug), y = AbsoluteTurnAngle, colour = Treatment)) +  ylim(0, 90) + geom_boxplot(outlier.shape = NA) + geom_point(data = ESInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_line(data = ESInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_jitter(position = "dodge", alpha = 0.3) + labs(x = "Dose", y = "Erratic swimming \n(Abs. Turn Angle)", color = "Treatment") + scale_colour_brewer(palette = "Set2") + theme_bw() + annotate(geom = "text", x = 0.8, y = 25, label = "b") + annotate(geom = "text", x = 1.2, y = 35, label = "a") + annotate(geom = "text", x = 1.8, y = 30, label = "ab") + annotate(geom = "text", x = 2.2, y = 30, label = "a")
```
...
FrplotARS <- ggplot(mk212_ARS, aes(x = factor(Drug), y = Freezing, colour = Treatment)) +  ylim(0, 110) + geom_boxplot(outlier.shape = NA) + geom_point(data = FrSInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_line(data = FrSInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_jitter(position = "dodge", alpha = 0.3) + labs(x = "Dose", y = "Freezing (s)", color = "Treatment") + scale_colour_brewer(palette = "Set2") + theme_bw() + annotate(geom = "text", x = 0.8, y = 10, label = "b") + annotate(geom = "text", x = 1.2, y = 55, label = "a") + annotate(geom = "text", x = 1.8, y = 30, label = "ab") + annotate(geom = "text", x = 2.2, y = 10, label = "b")
```
...
SpplotARS <- ggplot(mk212_ARS, aes(x = factor(Drug), y = Speed, colour = Treatment)) + ylim(0, 12) + geom_boxplot(outlier.shape = NA) + geom_point(data = SpInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_line(data = SpInt, aes(y = val, group = Treatment), position = position_dodge(width = 0.75)) + geom_jitter(position = "dodge", alpha = 0.3) + labs(x = "Dose", y = "Speed (cm/s)", color = "Treatment") + scale_colour_brewer(palette = "Set2") + theme_bw() + annotate(geom = "text", x = 0.8, y = 7.5, label = "a") + annotate(geom = "text", x = 1.2, y = 9, label = "a") +  annotate(geom = "text", x = 1.8, y = 7.5, label = "a") + annotate(geom = "text", x = 2.2, y = 10, label = "a")
```
